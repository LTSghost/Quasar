      ...
      <div class="q-pa-md">
        ...
        <div class="q-gutter-md row">
          <div class="col-10" style="text-align: center">
            ...
            <q-btn label="重置" type="reset" color="primary" class="q-ml-sm" />
          </div>
        </div>
      </div>
    </q-form>
  ...
  methods: {
    ...
    onSubmit: function () {
      if (this.accept !== true) {
        ...
        this.$store.commit("showcase/updatePracticeUserInfo", userInfo);
        setTimeout(() => {
          this.$q.loading.hide();
          this.$router.push("/exer2Sol_Result").then((e) => {
            this.$q.notify({
              color: "green-4",
              textColor: "white",
              icon: "cloud_done",
